...
static struct clk_vdd_class *gcc_scuba_regulators[] = {
	&vdd_cx,
	&vdd_mx,
};
...
static struct clk_regmap *gcc_scuba_clocks[] = {
	...
	[GCC_USB30_PRIM_MOCK_UTMI_POSTDIV] = &gcc_usb30_prim_mock_utmi_postdiv_clk_src.clkr,
...
static const struct qcom_cc_desc gcc_scuba_desc = {
	...
	.clk_regulators = gcc_scuba_regulators,
	.num_clk_regulators = ARRAY_SIZE(gcc_scuba_regulators),
};
...
static int gcc_scuba_probe(struct platform_device *pdev)
{
	 ...
	 * GCC_SYS_NOC_CPUSS_AHB_CLK, GCC_GPU_CFG_AHB_CLK, GCC_DISP_XO_CLK,
	 * GCC_DISP_AHB_CLK, GCC_CAMERA_XO_CLK, GCC_CAMERA_AHB_CLK,
	 * GCC_GPU_IREF_CLK
	 */
...
static void gcc_scuba_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &gcc_scuba_desc);
}
...
static struct platform_driver gcc_scuba_driver = {
	...
	.driver = {
		...
		.sync_state = gcc_scuba_sync_state,
	},
};
