...
static const struct of_device_id gcc_sdxpinn_virt_match_table[] = {
	{ .compatible = "qcom,sdxpinn-gcc-virt", .data = &gcc_sdxpinn_desc },
	{ }
};
MODULE_DEVICE_TABLE(of, gcc_sdxpinn_virt_match_table);

static struct platform_driver gcc_sdxpinn_virt_driver = {
	.probe = qcom_cc_virt_probe,
	.driver = {
		.name = "gcc-sdxpinn-virt",
		.of_match_table = gcc_sdxpinn_virt_match_table,
	},
};
...
{
	platform_driver_unregister(&gcc_sdxpinn_virt_driver);
