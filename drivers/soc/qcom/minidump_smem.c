...
static void md_smem_reg_kelfhdr_entry(unsigned int elfh_size)
{
...
static elf_addr_t md_smem_get_md_table(void)
{
...
static int md_smem_add_region(const struct md_region *entry, struct list_head *pending_list)
{
	u32 toc_init;
